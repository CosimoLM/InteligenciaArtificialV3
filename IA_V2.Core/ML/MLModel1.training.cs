...
namespace IA_V3_Core
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\liloc\Downloads\twitter_training.csv\twitter_training.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(@"col1", @"col1", outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    .Append(mlContext.Transforms.ReplaceMissingValues(@"col0", @"col0"))      
